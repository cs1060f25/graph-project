...
import { transformPapersToGraph, createMockGraphData } from '../../utils/graphDataTransformer';
...
describe('transformPapersToGraph', () => {
  ...
  it('should return empty graph for null input', () => {
    const result = transformPapersToGraph(null);
    expect(result).toEqual({ nodes: [], links: [] });
  });

  it('should transform API response format to graph nodes', () => {
    const papers = [
      {
        id: 'paper-1',
        title: 'Test Paper 1',
  ...
  it('should create links from references', () => {
    const papers = [
      {
        id: 'paper-1',
        title: 'Paper 1',
  ...
  it('should create links from citedBy', () => {
    const papers = [
      {
        id: 'paper-1',
        title: 'Paper 1',
  ...
  it('should create simple chain graph when no links exist', () => {
    const papers = [
  ...
  it('GRAPH-85: should preserve citation count of 0', () => {
    const papers = [
      {
        id: 'paper-1',
        title: 'Paper 1',
  ...
  it('GRAPH-85: should normalize OpenAlex IDs correctly', () => {
    const papers = [
      {
  ...
  it('GRAPH-85: should create edges from multiple citing papers', () => {
    const papers = [
      {
        id: 'paper-1',
        title: 'Paper 1',
  ...
  it('GRAPH-85: should not create edges to non-existent papers', () => {
    const papers = [
      {
        id: 'paper-1',
        title: 'Paper 1',
...
describe('createMockGraphData', () => {
  it('should create mock graph data with nodes and links', () => {
