// client/src/__tests__/hooks/useSavedPapers.test.js
...
describe('useSavedPapers', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(userApi.getSavedPapers).mockResolvedValue(mockPapers);
    vi.mocked(userApi.getFolders).mockResolvedValue(mockFolders);
    vi.mocked(userApi.updatePaper).mockResolvedValue({ success: true, data: {}, error: null });
    vi.mocked(userApi.deletePaper).mockResolvedValue({ success: true, data: {}, error: null });
  });
  ...
  describe('initialization', () => {
    ...
    it('should handle fetch errors gracefully', async () => {
      ...
      vi.mocked(userApi.getSavedPapers).mockRejectedValue(new Error(errorMessage));
  ...
  describe('addPaper', () => {
    it('should add a new paper', async () => {
      ...
      vi.mocked(userApi.savePaper).mockResolvedValue({
        success: true,
        data: newPaper,
        error: null,
      });
  ...
  describe('createFolder', () => {
    it('should create a new folder', async () => {
      ...
      vi.mocked(userApi.createFolder).mockResolvedValue(newFolder);
  ...
  describe('clearError', () => {
    it('should clear error state', async () => {
      vi.mocked(userApi.getSavedPapers).mockRejectedValue(new Error('Test error'));
