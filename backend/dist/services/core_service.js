...
export async function searchCore(query, maxResults = 10, mode = "") {
    /**
    ...
    try {
        ...
        const response = await axios.get(queryUrl, { headers, timeout: 15000 });
        ...
        for (const entry of entries) {
            ...
            const link = (entry.downloadUrl ||
                ...
                entry.uri ||
                "");
            results.push(new Paper(paperId, title, summary, published, authors, link, 'core'));
        }
        return results;
    }
    catch (error) {
...
//# sourceMappingURL=core_service.js.map