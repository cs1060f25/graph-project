...
MOCK_GRAPHS: Dict[str, GraphData] = {
    "graph-based contrastive learning": {
        ...
        "nodes": [
            {
                ...
                "year": 2023,
                "score": 0.94,
                "summary": "Introduces a contrastive pipeline tailored for recommender graphs with cold-start resilience.",
            ...
            },
            {
                ...
                "year": 2022,
                "score": 0.89,
                "summary": "Evaluates augmentation schemes for self-supervised objectives on graphs.",
            ...
            },
            {
                ...
                "year": 2021,
                "score": 0.88,
                "summary": "Benchmarks multiple GNN architectures on industry-scale recommendation datasets.",
                "tags": ["benchmark", "gnn"],
            },
            {
                "id": "n4",
                ...
                "year": 2020,
                "score": 0.81,
                "summary": "Models multi-session user behavior graphs for personalized ranking.",
                "tags": ["user", "embedding"],
            },
            {
                "id": "n5",
                ...
                "year": 2023,
                "score": 0.86,
                "summary": "Surveys self-supervised objectives for graphs and highlights contrastive variants.",
        ...
        "node_details": {
            "n1": {
                "summary": "Contrastive objectives tuned for implicit feedback graphs with ablations on negative sampling.",
            ...
            "n2": {
                "summary": "Systematic comparison of stochastic graph augmentations (edge-drop, mask) for contrastive tasks.",
            ...
            "n3": {
                "summary": "Provides reproducible baselines and metrics for industry-scale GNN recommenders.",
            ...
            "n5": {
                "summary": "Survey covering predictive, generative, and contrastive paradigms for self-supervised graphs.",
    ...
    "contrastive graph augmentation": {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "year": 2024,
                "score": 0.92,
                "summary": "Learns augmentation policies aligned with downstream recommender metrics.",
            ...
            },
            {
                ...
                "year": 2023,
                "score": 0.87,
                "summary": "Pre-training encoder-decoder graph models with multi-view contrastive losses.",
        ...
        "node_details": {
            ...
            "n6": {
                "summary": "Learns augmentation policies grounded in evaluation metrics with reinforcement learning.",
            ...
            "n7": {
                "summary": "Showcases improvements from pre-training encoders on unlabeled graphs before fine-tuning.",
    ...
    "gnn-based recommendation benchmarks": {
        "query": "gnn-based recommendation benchmarks",
        "center_node": "n3",
        "nodes": [
            {
            ...
            },
            {
                ...
                "year": 2020,
                "score": 0.8,
                "summary": "Defines standard evaluation pipelines for graph recommenders.",
            ...
            },
            {
                ...
                "year": 2022,
                "score": 0.82,
                "summary": "Discusses engineering challenges in deploying large-scale GNN recommenders.",
                "tags": ["scale", "systems"],
            },
        ],
        "edges": [
        ...
        "node_details": {
            ...
            "n8": {
                "summary": "Defines standardized dataset splits and metrics for graph recommenders.",
            ...
            "n9": {
                "summary": "Discusses distributed training and feature stores for industry-scale GNN recommenders.",
    ...
    "user behavior graph embeddings": {
        "query": "user behavior graph embeddings",
        "center_node": "n4",
        "nodes": [
            {
        ...
        "node_details": {
            ...
            "n11": {
                "summary": "Applies hypergraph neural networks to capture multi-item interactions per session.",
    ...
    "self-supervised graph representations": {
        "query": "self-supervised graph representations",
        "center_node": "n5",
        "nodes": [
            {
            ...
            },
            {
                ...
                "year": 2022,
                "score": 0.84,
                "summary": "Adapts masked language modeling to graphs with attribute imputation.",
            ...
            },
            {
                ...
                "year": 2023,
                "score": 0.83,
                "summary": "Predicts high-order motifs to regularize GNN encoders.",
        ...
        "node_details": {
            ...
            "n12": {
                "summary": "Applies masked modeling by randomly hiding nodes and edges and reconstructing them.",
                "authors": ["Wei Zhang", "Olivia Chen"],
                "venue": "NeurIPS 2022",
                "year": 2022,
                "tags": ["masked", "self-supervised"],
            ...
            "n13": {
                "summary": "Enforces predictive coding on motif frequencies to improve generalization.",
...
NODE_TO_QUERY: Dict[str, str] = {}

for graph in MOCK_GRAPHS.values():
    center_node = graph["center_node"].lower()
    NODE_TO_QUERY[center_node] = graph["query"].lower()
    for link in graph.get("related_queries", []):
        NODE_TO_QUERY[link["node_id"].lower()] = link["query"].lower()

for query_key, graph in MOCK_GRAPHS.items():
    normalized_query = query_key.lower()
    for node in graph["nodes"]:
        node_id = node["id"].lower()
        NODE_TO_QUERY.setdefault(node_id, normalized_query)


def get_graph_by_query(query: str) -> GraphData:
    normalized = query.lower()
    if normalized not in MOCK_GRAPHS:
        raise KeyError(f"No graph data found for query '{query}'.")
    return MOCK_GRAPHS[normalized]


def get_query_for_node(node_id: str) -> str:
    node_key = node_id.lower()
    if node_key not in NODE_TO_QUERY:
        raise KeyError(f"No query mapping found for node '{node_id}'.")
    return NODE_TO_QUERY[node_key]


def get_graph_by_node(node_id: str) -> GraphData:
    query = get_query_for_node(node_id)
    return get_graph_by_query(query)
