 ...
 */
export async function createSavedPaper(
  uid: string,
  paperData: Omit<SavedPaper, 'id' | 'createdAt' | 'updatedAt'>
): Promise<SavedPaper> {
  validateUserId(uid);
 ...
 */
export async function getSavedPapers(uid: string): Promise<SavedPaper[]> {
  validateUserId(uid);
 ...
 * @param paperId - Paper ID
 */
export async function deleteSavedPaper(uid: string, paperId: string): Promise<void> {
  validateUserId(uid);
...
export async function addQueryHistory(
  uid: string,
  queryData: Omit<QueryHistory, 'id' | 'timestamp' | 'createdAt'>
 ...
 */
export async function clearQueryHistory(uid: string): Promise<number> {
  validateUserId(uid);
