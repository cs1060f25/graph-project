...
import { addFolder } from "../userDataService.js";
...
async function runUnauthorizedAccessTest() {
  ...
  const uid1 = (await import("../firebaseConfig.js")).auth.currentUser.uid;
  ...
  const uid2 = (await import("../firebaseConfig.js")).auth.currentUser.uid;
