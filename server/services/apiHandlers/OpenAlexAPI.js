// server/services/apiHandlers/OpenAlexAPI.js
// Backend OpenAlexAPI - calls OpenAlex API directly
...
export default class OpenAlexAPI {
  ...
  /**
   * Fetch with timeout helper (using axios)
            ...
            try {
              ...
              while (hasMore && citingPapers.length < paper.citationCount) {
                ...
                if (citedByResponse.ok) {
                  const citedByData = citedByResponse.data;
