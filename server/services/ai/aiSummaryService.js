// server/services/ai/aiSummaryService.js
// Service for generating AI summaries using Google Generative AI

import { GoogleGenerativeAI } from '@google/generative-ai';

// Note: dotenv.config() is called in server/index.js, so env vars are already loaded

/**
 * Get the Google Generative AI API key from environment variables
 * Reads dynamically to ensure dotenv has loaded the .env file
 */
function getApiKey() {
  return process.env.GOOGLE_GENAI_API_KEY || process.env.REACT_APP_GOOGLE_GENAI_API_KEY;
}
